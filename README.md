...
The library is used by the [Hanzo ZT](https://github.com/hanzozt/zt) project
...
wrapping a specific tool. The Hanzo ZT examples mostly use the `zt` CLI.
...
Here's an example of a markdown file being run. This is the
 [creating your first service](https://github.com/hanzozt/zt/blob/v0.26.10/zt/cmd/zt/cmd/tutorial/tutorials/first-service.md)
 tutorial for [Hanzo ZT](https://github.com/hanzozt/zt), which is the most 
...
[viewed in the browser](https://github.com/hanzozt/zt/blob/v0.26.10/zt/cmd/zt/cmd/tutorial/tutorials/first-service.md) 
