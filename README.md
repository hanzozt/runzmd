...
The library is used by the [Hanzo ZT](https://github.com/hanzozt/ziti) project
...
wrapping a specific tool. The Hanzo ZT examples mostly use the `ziti` CLI.
...
Here's an example of a markdown file being run. This is the
 [creating your first service](https://github.com/hanzozt/ziti/blob/v0.26.10/ziti/cmd/ziti/cmd/tutorial/tutorials/first-service.md)
 tutorial for [Hanzo ZT](https://github.com/hanzozt/ziti), which is the most 
...
[viewed in the browser](https://github.com/hanzozt/ziti/blob/v0.26.10/ziti/cmd/ziti/cmd/tutorial/tutorials/first-service.md) 
...
blocks are outputted it using the [go-term-markdown](https://github.com/hanzozt/go-term-markdown)
